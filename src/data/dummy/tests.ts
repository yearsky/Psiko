    ...
    sections: [
      {
        ...
        questions: shuffle(verbalQuestions.filter(q => q.type === 'verbal_antonym')).slice(0, 15),
      ...
      },
      {
        ...
        questions: shuffle(verbalQuestions.filter(q => q.type === 'verbal_synonym')).slice(0, 15),
        timeLimitSeconds: 300,
      },
      {
        ...
        questions: shuffle(verbalQuestions.filter(q => q.type === 'verbal_analogy')).slice(0, 3),
        timeLimitSeconds: 300,
      },
    ],
  }),
    ...
    sections: [
      {
        ...
        questions: shuffle(numerikQuestions.filter(q => q.type === 'numerical_series')).slice(0, 20),
