    ...
    sections: [
      {
        ...
        questions: verbalQuestions.filter(q => q.type === 'verbal_antonym'),
      ...
      },
      {
        ...
        questions: verbalQuestions.filter(q => q.type === 'verbal_synonym'),
        timeLimitSeconds: 300,
      },
      {
        ...
        questions: verbalQuestions.filter(q => q.type === 'verbal_analogy'),
        timeLimitSeconds: 300,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        questions: numerikQuestions.filter(q => q.type === 'numerical_series'),
      ...
      },
      {
        ...
        questions: numerikQuestions.filter(q => q.type === 'numerical_arithmetic'),
        timeLimitSeconds: 600,
      ...
      },
      {
        ...
        questions: numerikQuestions.filter(q => q.type === 'numerical_word_problem'),
        timeLimitSeconds: 600,
    ...
    sections: [
      {
        ...
        questions: logikaQuestions.filter(q => q.type === 'logical_syllogism'),
        timeLimitSeconds: 600,
      },
      {
        ...
        questions: logikaQuestions.filter(q => q.type === 'logical_reasoning'),
        timeLimitSeconds: 600,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        questions: gambarQuestions.filter(q =>
      ...
      },
      {
        ...
        questions: gambarQuestions.filter(q => q.type === 'figure_matrix'),
        timeLimitSeconds: 600,
    ...
    sections: [
      {
        ...
        questions: verbalQuestions.slice(0, 10),
      ...
      },
      {
        ...
        questions: numerikQuestions.slice(0, 10),
        timeLimitSeconds: 900,
        questionTimeLimitSeconds: 90,
      },
      {
        ...
        questionTypes: ['logical_syllogism', 'logical_reasoning'],
        questions: logikaQuestions.slice(0, 10),
        timeLimitSeconds: 900,
      },
      {
        id: 'sec-cpns-gambar',
        ...
        questions: gambarQuestions.slice(0, 8),
        timeLimitSeconds: 900,
        questionTimeLimitSeconds: 30,
      },
    ],
